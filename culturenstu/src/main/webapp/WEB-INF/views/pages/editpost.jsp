	...
	<div class="four wide column">
		...
		<div class="ui list custom-head">
			...
			<div class="item">
				<i class="map marker icon"></i>
				<div class="content">
					<a class="header">Team Leader-Address</a>
			...
			<div class="item">
				...
				<div class="content">
					...
					<div class="description">${registeredModel.hall}.</div>
				</div>
			</div>
			<div class="item">
				<i class="map marker icon"></i>
				<div class="content">
					...
					<div class="description">${registeredModel.session}.</div>
				</div>
			</div>
			<div class="item">
				<i class="map marker icon"></i>
				<div class="content">
					...
					<div class="description">${registeredModel.slogan}.</div>
				</div>
			</div>
			<div class="item">
				<i class="map marker icon"></i>
				<div class="content">
					...
					<div class="description">${registeredModel.aim}.</div>
				</div>
			</div>
			<div class="item">
				<i class="map marker icon"></i>
				<div class="content">
					...
					<div class="description">${registeredModel.about}.</div>
				</div>
			</div>
			<div class="item">
				<i class="map marker icon"></i>
				<div class="content">
					<a class="header">Id</a>
					<div class="description">${registeredModel.rollId}.</div>
				</div>
			</div>
			<div class="item">
				<i class="map marker icon"></i>
				<div class="content">
					...
					<div class="description">${registeredModel.graduate}.</div>
				</div>
			</div>
		</div>
		...
		<div class="profile-page-content">
			...
			<div class="ui inverted segment">
				...
				<sf:form class="ui inverted form" modelAttribute="statusPost"
					action="${contextRoot}/edit/${statusPost.id}/regId/${registeredModel.id}"
					method="POST" enctype="multipart/form-data">
